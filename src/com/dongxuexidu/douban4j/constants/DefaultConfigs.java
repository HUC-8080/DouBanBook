 ...
 * @param  API_KEY			appkey
 * @param  SECRET_KEY		密钥
 * @param  API_URL_PREFIX	api.douban.com
 * @param  AUTH_URL			验证auth2协议
 * @param  ACCESS_TOKEN_URL 进入各种接口的钥匙
 */
public class DefaultConfigs {
  
  public static final String API_KEY = "0f7aff087d2228082e70fd1977667818";
  public static final String SECRET_KEY = "62c9f3723bb0cd2d";
  ...
  public static final String ACCESS_TOKEN_REDIRECT_URL = "http://127.0.0.1/DouBanBook/Usercode";
